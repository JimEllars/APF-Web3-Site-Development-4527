        ...
        {[1, 2].map((i) => (
          <div key={i} className="border border-white/10 p-6 flex flex-col sm:flex-row gap-6">
            ...
            <div>
              ...
              <button aria-label="View Details for Cascadia Guild Assembly" className="text-sm font-mono text-[#7100FF] uppercase tracking-widest hover:text-white transition-colors flex items-center gap-1">
